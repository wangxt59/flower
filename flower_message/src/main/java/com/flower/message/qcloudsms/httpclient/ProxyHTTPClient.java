...
public class ProxyHTTPClient implements HTTPClient {
    ...
    public com.github.qcloudsms.httpclient.HTTPResponse fetch(HTTPRequest request) throws IOException, URISyntaxException {
        // Build URI
        ...
        try {
            ...
            try {
                ...
                com.github.qcloudsms.httpclient.HTTPResponse res = new HTTPResponse()
                    .setRequest(request)
