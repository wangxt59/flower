package com.flower.message.qcloudsms;
...
public class SmsSingleSender extends SmsBase {
    ...
    public SmsSingleSenderResult send(int type, String nationCode, String phoneNumber,
        ...
        long random = com.github.qcloudsms.SmsSenderUtil.getRandom();
        long now = com.github.qcloudsms.SmsSenderUtil.getCurrentTime();
        JSONObject body = new JSONObject()
            .put("tel", (new JSONObject()).put("nationcode", nationCode).put("mobile", phoneNumber))
            .put("type", type)
            .put("msg", msg)
            .put("sig", com.github.qcloudsms.SmsSenderUtil.calculateSignature(this.appkey, random, now, phoneNumber))
            .put("time", now)
            .put("extend", com.github.qcloudsms.SmsSenderUtil.isNotEmpty(extend) ? extend : "")
            .put("ext", com.github.qcloudsms.SmsSenderUtil.isNotEmpty(ext) ? ext : "");
    ...
    public SmsSingleSenderResult sendWithParam(String nationCode, String phoneNumber, int templateId,
        ...
        JSONObject body = new JSONObject()
            .put("tel", (new JSONObject()).put("nationcode", nationCode).put("mobile", phoneNumber))
            .put("sig", com.github.qcloudsms.SmsSenderUtil.calculateSignature(appkey, random, now, phoneNumber))
